...
namespace syncfusion.spreadsheetdemos.wpf
{
    ...
    public class SpreadsheetProductDemos : ProductDemo
    {
        public SpreadsheetProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo()
            {
                SampleName = "Spreadsheet",
                Description = "Essential SfSpreadsheet is an Excel inspired control that allows you to create, edit, view and format the Microsoft Excel files without Excel installed. SfSpreadsheet provides absolute ease of use UI experience with integrated ribbon to cover any possible business scenario.",
                GroupName = "SHOWCASE",
                DemoViewType = typeof(syncfusion.spreadsheetdemo.wpf.SpreadSheetDemo),
