...
        private Visibility blurVisibility = Visibility.Collapsed;
        ...
        public ProductDemo SelectedProduct
        {
            ...
            set
            {
                ...
                if(_selectedproduct != null && !string.IsNullOrEmpty(_selectedproduct.Product) && _selectedproduct.Product.ToLower().Contains("olap") && isMainSB)
                {
                    OpenSourceCodeAction.OpenVS(_selectedproduct.Product);
                    return;
                }
